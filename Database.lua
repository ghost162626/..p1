...
local myHRP = lp.Character and lp.Character:FindFirstChild("HumanoidRootPart")
if myHRP then
    myHRP.CFrame = CFrame.new(0, 0, 0) -- Move o seu personagem para uma posição segura (pode ajustar para outro local)
end

-- PASSO 6: Levar o jogador para o void de baixo (mudei a altura para um valor bem negativo para o void)
